...
//export const API_URL = 'http://37.187.113.139:8080/api';
var API_URL = '/api';
...
var BasicAuthenticationService = /** @class */ (function () {
    ...
    BasicAuthenticationService.prototype.authenticateJWT = function (username, password) {
        //return this.http.post<any>(`http://37.187.113.139:8080/authenticate`, //dev
        return this.http.post("/authenticate", //prod
        { username: username, password: password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            sessionStorage.setItem(AUTHENTICATER_USER, username);
            sessionStorage.setItem(TOKEN, "Bearer " + data.token);
            return data;
        }));
    };
    BasicAuthenticationService.prototype.authenticateBasic = function (username, password) {
    ...
    BasicAuthenticationService.prototype.logoutBasic = function () {
        this.logout();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
...
module.exports = __webpack_require__(/*! /home/danielmir/projects/udemy/full-stack/restfull-angular-client/src/main.ts */"./src/main.ts");
